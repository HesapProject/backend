        ...
        .authorizeExchange(
            exchanges ->
                exchanges
                    ...
                    .permitAll()
                    .pathMatchers("/files/v3/api-docs/**")
                    .permitAll()
                    .pathMatchers("/v3/api-docs/**")
                    .permitAll()
                    // Public CDN download — cdn.hesap.uz orqali tashqi clientlar
                    .pathMatchers(org.springframework.http.HttpMethod.GET, "/files/v1/cdn/*/*")
                    .permitAll()
                    .anyExchange()
                    .authenticated())
