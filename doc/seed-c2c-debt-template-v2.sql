-- =============================================================================
-- C2C QARZ SHARTNOMASI v2 — haqdor/qarzdor (creditor/debtor)
-- User ma'lumotlari PDF da avtomatik: DocumentGenerator + UserService passport-basic
--
-- Ishlatish:
--   psql -h localhost -p 5435 -U postgres -d hesap -f doc/seed-c2c-debt-template-v2.sql
--
-- UUID lar:
--   C2C   : a1000001-0001-4001-8001-000000000011
--   NOTICE: a1000001-0001-4001-8001-000000000012  (template_id -> C2C)
--   REPORT: a1000001-0001-4001-8001-000000000013  (template_id -> C2C)
--
-- API da hali sellerId/buyerId — PDF da:
--   sellerUserId → creditor* (haqdor / qarz beruvchi)
--   buyerUserId  → debtor*   (qarzdor / qarz oluvchi)
--
-- DocumentGenerator AVTO paramlar:
--   number, price, currency, createdDate, address
--   creditorFullName, creditorDocument, creditorPinfl, creditorPhone, creditorAddress
--   debtorFullName, debtorDocument, debtorPinfl, debtorPhone, debtorAddress
--   paymentScheduleList
--
-- template_field (ixtiyoriy, faqat 1 ta):
--   priceWords — summa so'z bilan (entityda yo'q)
-- =============================================================================
...
INSERT INTO document.template (
    ...
    NULL,
    'C2C qarz shartnomasi v2 (haqdor/qarzdor)',
    'C2C договор займа v2',
    'C2C loan agreement v2',
...
<jasperReport xmlns="http://jasperreports.sourceforge.net/jasperreports"
              ...
              uuid="a1000001-0001-4001-8001-000000000011">
    ...
    <parameter name="creditorFullName" class="java.lang.String"/>
    <parameter name="debtorFullName" class="java.lang.String"/>
    <parameter name="price" class="java.lang.String"/>
    <parameter name="currency" class="java.lang.String"/>
    <parameter name="priceWords" class="java.lang.String"/>
    <parameter name="creditorDocument" class="java.lang.String"/>
    <parameter name="creditorPinfl" class="java.lang.String"/>
    <parameter name="creditorPhone" class="java.lang.String"/>
    <parameter name="debtorDocument" class="java.lang.String"/>
    <parameter name="debtorPinfl" class="java.lang.String"/>
    <parameter name="debtorPhone" class="java.lang.String"/>
    ...
    <title>
        <band height="720" splitType="Stretch">
            ...
            <textField isStretchWithOverflow="true">
                ...
                <textFieldExpression><![CDATA["Bir tomondan fuqaro " + $P{creditorFullName} + " (keyingi o‘rinlarda \"Qarz beruvchi\" deb yuritiladi), ikkinchi tomondan fuqaro " + $P{debtorFullName} + " (keyingi o‘rinlarda \"Qarz oluvchi\" deb yuritiladi) birgalikda Tomonlar, alohida-alohida — Tomon deb yuritilgan holda quyidagilar haqida shartnoma tuzdilar:"]]></textFieldExpression>
            </textField>
    ...
    <summary>
        <band height="180" splitType="Stretch">
            ...
            <textField isStretchWithOverflow="true">
                ...
                <textElement><font fontName="Times New Roman" size="10"/></textElement>
                <textFieldExpression><![CDATA["F.I.SH: " + $P{creditorFullName} + "\nPasport seriya: " + $P{creditorDocument} + "\nJSHSHIR: " + $P{creditorPinfl} + "\nTel: " + $P{creditorPhone}]]></textFieldExpression>
            </textField>
            <textField isStretchWithOverflow="true">
                <reportElement x="241" y="18" width="240" height="80" uuid="f4"/>
                <textElement><font fontName="Times New Roman" size="10"/></textElement>
                <textFieldExpression><![CDATA["F.I.SH: " + $P{debtorFullName} + "\nPasport seriya: " + $P{debtorDocument} + "\nJSHSHIR: " + $P{debtorPinfl} + "\nTel: " + $P{debtorPhone}]]></textFieldExpression>
            </textField>
        </band>
    </summary>
...
-- ---------------------------------------------------------------------------
-- 2) template_field — faqat priceWords (qolganlari DocumentGenerator avtomatik)
-- ---------------------------------------------------------------------------
...
VALUES
    ('a1000002-0001-4001-8001-000000000021', 'a1000001-0001-4001-8001-000000000011', 'priceWords', 'Summa so''z bilan', 'Сумма прописью', 'Price in words', 'STRING', 'BOTTOM', NULL, FALSE, NOW(), NOW());
    ...
    <title>
        <band height="400">
            ...
            <textField isStretchWithOverflow="true">
                ...
                <textElement textAlignment="Justified"><font fontName="Times New Roman" size="10"/></textElement>
                <textFieldExpression><![CDATA["Hurmatli " + $P{debtorFullName} + "!\n\n" +
"Siz bilan " + $P{creditorFullName} + " o'rtasida " + $P{createdDate} + " sanasida tuzilgan " +
...
$P{creditorFullName} + " va " + $P{debtorFullName} + " o'rtasidagi " + $P{number} +
...
-- SELECT key_name, name_uz FROM document.template_field WHERE template_id = 'a1000001-0001-4001-8001-000000000011';
